...
const SEO_SUKNI =
  "Купити сукню в Києві з доставкою по Україні — просто: у каталозі ANKE зібрані сукні на кожен сценарій життя. Лляні міді на щодень і в офіс, віскозні максі на відпустку, твідові міні на побачення і атласні вечірні — на події, де хочеться бути найкрасивішою.\n\nANKE — шоурум: ми не шиємо, а відбираємо моделі з натуральних тканин — льон, віскоза, шовк, твід з вовною — і перевіряємо кожну руками. У кожній картці — чесний склад, обміри в сантиметрах і параметри моделі на фото, щоб розмір було легко вгадати з першого разу. Якщо сумніваєтесь — стилісти ANKE підкажуть у Telegram.\n\nЗамовлення відправляємо Новою Поштою того ж дня (до 14:00), доставка 1–3 дні. Не підійшло — обмін або повернення протягом 14 днів без зайвих питань. А ще сукню можна приміряти в шоурумі в Києві — відкладемо ваш розмір перед візитом.";
const SEO_ODYAH =
  "Жіночий одяг ANKE — це гардероб, який збирається як конструктор: сукні, костюми, блузи, трикотаж і верхній одяг у спільній палітрі та стриманій естетиці. Кожну модель ми відбираємо руками, а тканини — головний критерій: льон, вовна, кашемір, шовк, щільна бавовна.\n\nМи віримо в повільну моду: речі ANKE носяться роками і дружать між собою, тому капсула з п'яти позицій дає десятки образів. У кожній картці — чесний склад, догляд і параметри моделі; у кабінеті — трекінг замовлення до дверей.\n\nДоставка Новою Поштою по Україні 1–3 дні, оплата карткою, частинами або при отриманні. Обмін і повернення — 14 днів.";

export const CATEGORY_TREE: CategoryNode[] = [
  c("odyah", "Одяг", ["odyah"], "Жіночий одяг ANKE: сукні, костюми, трикотаж і верхній одяг у стриманій естетиці.", [
